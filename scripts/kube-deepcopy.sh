...
./tool/go run  sigs.k8s.io/controller-tools/cmd/controller-gen 	object:headerFile=./header.txt paths=./kube/apis/...
...
sed -i "1 s|$| \&\& \!plan9|" kube/apis/v1alpha1/zz_generated.deepcopy.go
